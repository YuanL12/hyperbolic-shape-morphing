...
DEFAULT_ENDPOINTS = [
    ...
    "input/example_genus3_klein_quartic_triangulation_all_1_solution.json",
    "input/example_genus3_klein_quartic_triangulation_half_10_solution.json",
    "input/example_genus3_klein_quartic_convex_quad_pent_graph_all_1_solution.json",
    "input/example_genus3_klein_quartic_convex_quad_pent_graph_half_10_solution.json",
]
