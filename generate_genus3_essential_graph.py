...
from generate_genus3_klein_embedding import KLEIN_SIDE_LABELS, write_preview_svg
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        default="input/example_genus3_klein_quartic_essential_graph.json",
    )
    parser.add_argument(
        "--preview-svg",
        default="output/genus3_klein_essential_graph.svg",
    )
