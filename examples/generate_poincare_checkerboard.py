...
from hyper_morph.embedding import poincare_geodesic_points
from hyper_morph.solver import MobiusIsometry, to_complex
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        default="examples/output/poincare_checkerboard_genus2_depth2.svg",
