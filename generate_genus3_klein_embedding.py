...
from directed_edge_weights import DirectedEdgeWeightCalculator, compose_mobius
from embedding_utils import validate_disk_embedding
from poincare_harmonic_map import HarmonicMapSolver, MobiusIsometry, from_complex
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--preview-svg",
        default="output/genus3_klein_initial_embedding.svg",
